    ...
    return (
        <Fragment>
            <Container fluid={true} className="content-body">
                ...
                {
                                CanceledList.map((item, i) => <div key={i.toString()}  className="col-12 col-lg-4 col-sm-6 col-md-4  p-2">
                                <div  className="card h-100">
                                    <div className="card-body">
                                        ...
                                        <a onClick={StatusChangeItem.bind(this,item._id,item.status)} href className="icon-nav text-primary mx-1"><AiOutlineEdit /></a>
                                            ...
                                            <a className="badge float-end bg-danger text-decoration-none" href>{item.status}</a>
                                        </p>
                                    </div>
                                </div>
                                </div>
