    ...
    return (
        <Fragment>
            <Container fluid={true} className="content-body">
                ...
                {
                                CompletedList.map((item, i) => <div key={i.toString()}  className="col-12 col-lg-4 col-sm-6 col-md-4  p-2">
                                <div  className="card h-100">
                                    <div className="card-body">
                                        ...
                                        <p className="m-0 animated fadeInUp p-0">
                                            ...
                                            <a className="badge float-end bg-success text-decoration-none" href>{item.status}</a>
                                        </p>
                                    </div>
                                </div>
                                </div>
