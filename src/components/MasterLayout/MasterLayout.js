...
import {AiOutlineCheckCircle, AiOutlineEdit, AiOutlineAppstore, AiOutlineLogout, AiOutlineMenuUnfold, AiOutlineUser, AiOutlineCloseSquare} from "react-icons/ai";
        ...
        <Fragment>
            ...
            <div ref={(div) =>{sideNavRef=div}} className="side-nav-open">
                ...
                <NavLink   className={(navData) => navData.isActive ? "side-bar-item-active side-bar-item mt-2" : "side-bar-item mt-2" }  to="/"  end>
                    <AiOutlineAppstore className="side-bar-item-icon" />
                    <span className="side-bar-item-caption border-none">Dashboard</span>
                </NavLink>
                ...
                <NavLink className={(navData) => navData.isActive ? "side-bar-item-active side-bar-item mt-2" : "side-bar-item mt-2" }  to="/Canceled" >
                    <AiOutlineCloseSquare className="side-bar-item-icon" />
